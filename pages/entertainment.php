...
<head>
    ...
    <title>Birthday Services | Eventro </title>
    ...
    <style>
        ...
        .hero-bg {
            background: url('../assets/concert.jpg') center/cover no-repeat;
            position: relative;
        }
        .hero-bg::before {
            content: '';
...
<div class="hero-bg text-white py-20">
    <div class="hero-content max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 class="text-5xl md:text-6xl font-bold mb-6">Entertainment Services</h1>
        ...
        <div class="flex justify-center items-center space-x-8 text-lg">
            <div class="flex items-center">
                ...
                <span><?= mysqli_num_rows($result_services) ?>+ Entertainment Services</span>
            </div>
            <div class="flex items-center">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
            <div class="flex items-center space-x-2">
                ...
                <div>
                    <span class="font-semibold text-gray-900 block">Find Entertainment services in your area</span>
                </div>
            </div>
            ...
            <?php if (!empty($selected_district)): ?>
                <a href="entertainment.php" class="inline-flex items-center px-3 py-2 text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors duration-200">
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Popular Entertainment Events </h3>
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
            <?php 
            $photo_types = [
                ['name' => 'Live Concert', 'icon' => 'fas fa-microphone', 'color' => 'blue'],
                ['name' => 'DJ Party', 'icon' => 'fas fa-headphones', 'color' => 'purple'],
                ['name' => 'Comedy Show', 'icon' => 'fas fa-laugh', 'color' => 'yellow'],
                ['name' => 'Musical Performance', 'icon' => 'fas fa-guitar', 'color' => 'green'],
                ['name' => 'Fashion Show', 'icon' => 'fas fa-tshirt', 'color' => 'red']
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
    <?php if (mysqli_num_rows($result_services) > 0): ?>
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-900">
                Entertainment Services <?= !empty($selected_district) ? 'in ' . htmlspecialchars($selected_district) : '' ?>
            </h2>
            <p class="text-gray-600">Found <?= mysqli_num_rows($result_services) ?> entertainment<?= mysqli_num_rows($result_services) !== 1 ? 's' : '' ?></p>
        </div>
    ...
    <?php else: ?>
        <div class="text-center py-16">
            ...
            <h3 class="text-xl font-semibold text-gray-700 mb-2">No Entertainment Events found</h3>
            <p class="text-gray-500">
                <?php if ($selected_district): ?>
                    No Entertainment Events found in <?= htmlspecialchars($selected_district) ?>. Try selecting a different location.
                <?php else: ?>
                    No Entertainment Events are currently available. Check back later!
                <?php endif; ?>
            </p>
        </div>
    <?php endif; ?>
