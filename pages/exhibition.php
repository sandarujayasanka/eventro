...
<head>
    ...
    <title>Exhibition Services | Eventro </title>
    ...
    <style>
        ...
        .hero-bg {
            background: url('../assets/exhi.jpg') center/cover no-repeat;
            position: relative;
        }
        .hero-bg::before {
            content: '';
...
<div class="hero-bg text-white py-20">
    <div class="hero-content max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 class="text-5xl md:text-6xl font-bold mb-6">Exhibition Services</h1>
        ...
        <div class="flex justify-center items-center space-x-8 text-lg">
            <div class="flex items-center">
                ...
                <span><?= mysqli_num_rows($result_services) ?>+Exhibition Services</span>
            </div>
            <div class="flex items-center">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
            ...
            <?php if (!empty($selected_district)): ?>
                <a href="exhibition.php" class="inline-flex items-center px-3 py-2 text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors duration-200">
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Popular Exhibition Events </h3>
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
            <?php 
            $photo_types = [
                ['name' => 'Job & Career Fairs', 'icon' => 'fas fa-briefcase', 'color' => 'blue'],
                ['name' => 'Health Exhibitions', 'icon' => 'fas fa-heartbeat', 'color' => 'purple'], 
                ['name' => 'Book Fairs', 'icon' => 'fas fa-book', 'color' => 'yellow'], 
                ['name' => 'Educational Exhibitions', 'icon' => 'fas fa-graduation-cap', 'color' => 'green'], 
                ['name' => 'Automobile Exhibitions', 'icon' => 'fas fa-car', 'color' => 'red'] 
            ];
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
    <?php if (mysqli_num_rows($result_services) > 0): ?>
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-900">
                Exhibition Services <?= !empty($selected_district) ? 'in ' . htmlspecialchars($selected_district) : '' ?>
            </h2>
            <p class="text-gray-600">Found <?= mysqli_num_rows($result_services) ?> exhibition<?= mysqli_num_rows($result_services) !== 1 ? 's' : '' ?></p>
        </div>
    ...
    <?php else: ?>
        <div class="text-center py-16">
            ...
            <h3 class="text-xl font-semibold text-gray-700 mb-2">No Exhibition Events found</h3>
            <p class="text-gray-500">
                <?php if ($selected_district): ?>
                    No Exhibition Events found in <?= htmlspecialchars($selected_district) ?>. Try selecting a different location.
                <?php else: ?>
                    No Exhibition Events are currently available. Check back later!
                <?php endif; ?>
            </p>
        </div>
    <?php endif; ?>
