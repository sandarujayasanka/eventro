...
<head>
    ...
    <title>Corporate Services | Eventro </title>
    ...
    <style>
        ...
        .hero-bg {
            background: url('../assets/product.webp') center/cover no-repeat;
            position: relative;
        }
        .hero-bg::before {
            content: '';
...
<div class="hero-bg text-white py-20">
    <div class="hero-content max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="mb-6">
            <i class="fas fa-rocket text-6xl mb-4 opacity-90"></i>
        </div>
        <h1 class="text-5xl md:text-6xl font-bold mb-6">Corporate Services</h1>
        ...
        <div class="flex justify-center items-center space-x-8 text-lg">
            <div class="flex items-center">
                ...
                <span><?= mysqli_num_rows($result_services) ?>+ Corporate Services</span>
            </div>
            <div class="flex items-center">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
            <div class="flex items-center space-x-2">
                ...
                <div>
                    <span class="font-semibold text-gray-900 block">Find Corporate services in your area</span>
                </div>
            </div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Popular Corporate Events </h3>
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
            <?php 
            $photo_types = [
                ['name' => 'Conference', 'icon' => 'fas fa-users', 'color' => 'blue'],
                ['name' => 'Product Launch', 'icon' => 'fas fa-rocket', 'color' => 'purple'],
                ['name' => 'Annual General Meeting', 'icon' => 'fas fa-handshake', 'color' => 'yellow'],
                ['name' => 'Team Building', 'icon' => 'fas fa-user-friends', 'color' => 'green'],
                ['name' => 'Award Ceremony', 'icon' => 'fas fa-trophy', 'color' => 'red']
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
    <?php if (mysqli_num_rows($result_services) > 0): ?>
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-900">
                Corporate Services <?= !empty($selected_district) ? 'in ' . htmlspecialchars($selected_district) : '' ?>
            </h2>
    ...
    <?php else: ?>
        <div class="text-center py-16">
            ...
            <h3 class="text-xl font-semibold text-gray-700 mb-2">No Corporate Events found</h3>
            <p class="text-gray-500">
                <?php if ($selected_district): ?>
                    No Corporate Events found in <?= htmlspecialchars($selected_district) ?>. Try selecting a different location.
                <?php else: ?>
                    No Corporate Events are currently available. Check back later!
                <?php endif; ?>
            </p>
        </div>
    <?php endif; ?>
