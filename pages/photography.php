...
<head>
    ...
    <title>Photography Services | Eventro</title>
    ...
    <style>
        ...
        .hero-bg {
            background: url('../assets/photography.avif') center/cover no-repeat;
            position: relative;
        }
        .hero-bg::before {
            content: '';
...
<div class="hero-bg text-white py-20">
    <div class="hero-content max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="mb-6">
            <i class="fas fa-camera text-6xl mb-4 opacity-90"></i>
        </div>
        <h1 class="text-5xl md:text-6xl font-bold mb-6">Photography Services</h1>
        <p class="text-xl mb-8 opacity-90 max-w-3xl mx-auto">Capture your precious moments with professional photographers. From weddings to portraits, find the perfect photographer for your needs.</p>
        
        <!-- Quick Stats -->
        <div class="flex justify-center items-center space-x-8 text-lg">
            <div class="flex items-center">
                <i class="fas fa-users mr-2"></i>
                <span><?= mysqli_num_rows($result_services) ?>+ Photographers</span>
            </div>
            <div class="flex items-center">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
            <div class="flex items-center space-x-2">
                ...
                <div>
                    <span class="font-semibold text-gray-900 block">Find photographers in your area</span>
                </div>
            </div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Popular Photography Types</h3>
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
            <?php 
            $photo_types = [
                ['name' => 'Portrait', 'icon' => 'fas fa-user-circle', 'color' => 'blue'],
                ['name' => 'Fashion', 'icon' => 'fas fa-female', 'color' => 'purple'],
                ['name' => 'Product', 'icon' => 'fas fa-box', 'color' => 'yellow'],
                ['name' => 'Event', 'icon' => 'fas fa-calendar-check', 'color' => 'green'],
                ['name' => 'Real Estate', 'icon' => 'fas fa-home', 'color' => 'red'],
                ['name' => 'Food', 'icon' => 'fas fa-utensils', 'color' => 'orange'],
                ['name' => 'Nature', 'icon' => 'fas fa-tree', 'color' => 'green'],
                ['name' => 'Street', 'icon' => 'fas fa-road', 'color' => 'gray'],
                ['name' => 'Architecture', 'icon' => 'fas fa-building', 'color' => 'indigo'],
                ['name' => 'Sports', 'icon' => 'fas fa-running', 'color' => 'red'],
                ['name' => 'Commercial', 'icon' => 'fas fa-briefcase', 'color' => 'blue'],
                ['name' => 'Maternity', 'icon' => 'fas fa-baby', 'color' => 'pink']
            ];
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
    <?php if (mysqli_num_rows($result_services) > 0): ?>
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-900">
                Photography Services <?= !empty($selected_district) ? 'in ' . htmlspecialchars($selected_district) : '' ?>
            </h2>
            <p class="text-gray-600">Found <?= mysqli_num_rows($result_services) ?> photographer<?= mysqli_num_rows($result_services) !== 1 ? 's' : '' ?></p>
        </div>
    ...
    <?php else: ?>
        <div class="text-center py-16">
            ...
            <h3 class="text-xl font-semibold text-gray-700 mb-2">No photographers found</h3>
            <p class="text-gray-500">
                <?php if ($selected_district): ?>
                    No photographers found in <?= htmlspecialchars($selected_district) ?>. Try selecting a different location.
                <?php else: ?>
                    No photographers are currently available. Check back later!
                <?php endif; ?>
            </p>
        </div>
    <?php endif; ?>
